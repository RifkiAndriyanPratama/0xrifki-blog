...
Angka 5 yang kamu tulis di kode? Di dalam memori, dia tersimpan sebagai `0101`. Angka 3? `0011`. Semua operasi, tambah, kurang, kali, bagi, semuanya pada akhirnya dieksekusi sebagai manipulasi bit di level hardware.
